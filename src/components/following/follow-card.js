...
// import "../../assets/css/follow-people.css";
...
class Search extends React.Component {
    ...
    handleChange(e) {
        this.setState({ searchText: e.target.value }, () => {
            this.props.searchTextFunc(this.state.searchText);
        });
    }
...
function FollowPeoples({
    ...
    const gettingUser = res => {
        const usersVar = [...users, res];
        setUsers(usersVar);
    }

    const searchTextFunct = res => {
        setSearchText(res);
    }
    return (
                ...
                <div className='row'>
                    <div className='page-header'>
                        <div className='d-flex align-items-center'>
                            <h2 className='page-header-title'>Follow People</h2>
                        </div>
                    </div>
                </div>
                <div className='row'>
                    <Search searchTextFunc={searchTextFunct} />
                </div>
                {/* <div className='row'>
                    ...
                    <main className='listOfCards'>
                        {
                            users
                                ...
                                .map((user, index) => (
                                    <Videos key={index} name={user.name} email={user.email} pic={user.pic} username={user.username} />
                                ))
                        }
                        {/* <NewUser gettingUser={gettingUser} /> */}
                    </main>
                </div>
            </div>
        </div>
